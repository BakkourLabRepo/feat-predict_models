...
class BaseModel:
    ...
    memory_sampler: bool
        If False, only retrieve exact matches in memory at inference
    ...
    def get_sampler_weights(
        ...
        """
        Get sampler weights based on input feature similarity and
    ...
    def set_task(self, w_env):
        ...
        # Compute value function for current task
        self.compute_V()
